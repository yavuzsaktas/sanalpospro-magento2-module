...
namespace Sanalpospro\SanalPosPro\Lib\PaythorClient;
...
class PaythorClient
{
     ...
     * @param string $publicKey
     * @param string $secretKey
     * @deprecated 1.0.0 Naming was misleading; the method only generates and returns a hash.
     * @see \Sanalpospro\SanalPosPro\Lib\PaythorClient\PaythorClient::generateHash()
     */
