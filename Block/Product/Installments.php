...
namespace Sanalpospro\SanalPosPro\Block\Product;
...
class Installments extends Template
{
    ...
    public function getCardImageUrl(string $family): string
    {
        ...
        return $this->getViewFileUrl('Sanalpospro_SanalPosPro::images/cards/' . $file . '.png');
    }
