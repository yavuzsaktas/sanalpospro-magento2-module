        ...
        try {
            ...
            if ($pendingQuoteId === 0 || $pendingQuoteId !== (int)$reference) {
                ...
                if ($alreadyCreatedOrderId > 0) {
                    $this->logger->info(
                        'Paythor Confirm: order already created by browser-redirect flow, returning success',
                        [
            ...
            if ($processId !== '') {
                ...
                if ($processResult['is_approved']) {
                    ...
                    $order->addCommentToStatusHistory(
                        __(
                            'Paythor: browser callback received, status pending (%1). Awaiting server webhook.',
